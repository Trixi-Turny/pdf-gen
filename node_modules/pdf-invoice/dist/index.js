...
function PDFInvoice(_ref) {
  ...
  return {
    genHeader: function genHeader() {
      ...
      doc.strokeColor('#ffb300').moveTo(CONTENT_LEFT_PADDING, borderOffset).lineTo(divMaxWidth, borderOffset);
    },
    ...
    genTableHeaders: function genTableHeaders() {
      ...
      ['date', 'description', 'local_amount', 'fx_rate', 'amount'].forEach(function (text, i) {
        console.log("generating tableheader items" + ' '+i+' '+ text);
        // console.log(doc.fontSize(TEXT_SIZE).text(text, table.x + i * table.inc, table.y));
        doc.fontSize(TEXT_SIZE).text(text, table.x + table.inc[i], table.y);
