  ...
  return {
    ...
    genTableHeaders: function genTableHeaders() {
      ...
      var tablehead = ['Date', 'Description', 'Local amount \n (if applicable', 'FX Rate \n (if applicable)', 'Amount'].forEach(function (text, i) {
        doc.font('assets/montserrat-semiBold.ttf').fontSize(10).text(text, table.x + table.inc[i], table.y);
    ...
    genTableRow: function genTableRow() {
      ...
      items.map(function (item) {
        ...
        var tableRow = ['date', 'description', 'local_amount', 'fx_rate', 'amount'].forEach(function (field, i) {
    ...
    genTableLines: function genTableLines() {
      ...
      var offset = doc.currentLineHeight() + 30;
      doc.moveTo(table.x, table.y + offset).lineTo(divMaxWidth, table.y + offset);
    },
