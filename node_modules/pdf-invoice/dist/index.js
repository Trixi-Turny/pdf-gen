  ...
  function generateTableForPage(chunk){
    ...
    chunk.forEach(function (item, itemIndex) {
      ['date', 'description', 'local_amount', 'fx_rate', 'amount'].forEach(function (field, i) {
        ...
        // var rowBottomY = Math.max(350 + computeRowHeight(table.headers), rowBottomY);
        // doc.moveTo(350, rowBottomY - rowSpacing * 0.5)
        // .lineTo(CONTENT_LEFT_PADDING + usableWidth, rowBottomY - rowSpacing * 0.5)
        // .lineWidth(2)
        // .stroke();
